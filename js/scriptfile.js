...
window.onload = function() {
  ...
  function resetTimer(sessionNow, sessionClicked) {
    ...
    document.getElementById('circle').style.background = '#F44336';
  }
  ...
  function timerTick() {
    if (currentTime <= 0) {
      ...
      document.getElementById('circle').style.background = 'linear-gradient(#F44336 ' + currentTime/(session == ' session' ? sessionLength*60 : breakLength*60)*100 + '%, #27AE60 0)';
    }
  }
}